"""
Modelo preentrenado descargado de: https://github.com/ustcqidi/BeautyPredict
Autores: ustcqidi et al.
Uso permitido: investigación y educación, no comercial
...
# https://github.com/ivadym/FERehab/blob/master/trained_models/ResNet-50.h5
